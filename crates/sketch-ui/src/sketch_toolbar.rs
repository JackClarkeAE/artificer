...
const TOOL_DESCRIPTORS: [ToolDescriptor; ToolVariant::COUNT] = [
    ...
    descriptor(
        ...
        "Choose line or spline type; current default: Chained polyline.",
        Some(SHORTCUT_L),
        ToolIcon::Polyline,
        ToolCursor::Crosshair,
        POLYLINE_PHASES,
    ...
    descriptor(
        ...
        "Choose line or spline type; current default: Centreline.",
        Some(SHORTCUT_L),
        ToolIcon::Centreline,
        ToolCursor::Crosshair,
        LINE_PHASES,
    ...
    descriptor(
        ...
        ToolFamily::Dimension,
        "Sketch dimension",
        "Display and edit a driving dimension on sketch geometry, or between two points.",
        "Click a sketch curve to arm its own driving dimensions, or click two endpoints to dimension the distance between them. Type the exact value in the box on the canvas or in the palette; it applies on Enter or when you click away.",
        "Click a curve to dimension it, or two endpoints to dimension between them.",
