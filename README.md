...
A release in two halves. The kernel half is about exactness: two bores that
cross used to leave the exact domain and come back as a tessellation, and now
they do not. The workbench half is about changing your mind — trim that works
on the edge you drew over, a dimension that answers the question you asked, an
extrusion that reaches the face you click, and an extrusion you can reopen and
